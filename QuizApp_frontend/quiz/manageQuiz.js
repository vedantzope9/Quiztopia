...
document.addEventListener("DOMContentLoaded", () => {
    const cancelButtonAllQuizzes = document.getElementById("cancelButtonAllQuizzes");
    const cancelButtonQuizQuestions = document.getElementById("cancelButtonQuizQuestions");

    if (cancelButtonAllQuizzes) {
        cancelButtonAllQuizzes.addEventListener("click", () => window.history.back());
    }

    if (cancelButtonQuizQuestions) {
        cancelButtonQuizQuestions.addEventListener("click",  () => window.history.back());
    }
});
